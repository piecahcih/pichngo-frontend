...
function LoginCard() {
    ...
    const handleGoogleLogin = async () => {
        try {
            ...
            await useUserStore.getState().registerorLoginWithGoogle(idToken, userData)
            navigate("/")
        } catch (error) {
                ...
                <div className=" w-fit m-9">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <fieldset disabled={isSubmitting}>
                            ...
                            <button className="bg-primary hover:bg-[#b5390e] text-white rounded-[18px] p-2 w-[328px] mb-4" disabled={!isValid}>
                    ...
                    <div className="flex justify-center gap-4 h-[40px] w-[328px]">
                        <button onClick={handleGoogleLogin} className="w-full flex gap-3 items-center justify-center transition-transform active:scale-95 bg-base-100 rounded-full p-2 shadow-sm hover:bg-gray-200">

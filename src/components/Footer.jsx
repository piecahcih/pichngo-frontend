        ...
        <div className="bg-secondary text-white px-25 pt-10 pb-5">
            <div className="flex justify-between">
                <div className="">
                    ...
                    <p className="w-[250px] break-all font-['Whitney-Light'] text-[14px]">This website is intended for the educational purposes only. Most of the photos credited to Agoda. Not for commercial use.</p>
                </div>
